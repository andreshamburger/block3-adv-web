...
class species_model {
   ...
   public function insert_species($species_name, $species_price){
      $mysqli = $this->connect();
      if ($mysqli) {
         $mysqli->query("INSERT INTO species (species_Name, species_price) VALUES ('$species_name', '$species_price')");
         $mysqli->close();
         return true;
      } else {
         return false;
