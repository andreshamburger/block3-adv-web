...
class pets_model
{
   ...
   public function add_new_pets($pets_name, $species_id, $breeds_id, $pets_age, $pets_gender, $pets_neutered, $pets_price, $toys_id)
   {
      ...
      if ($mysqli) {
         $mysqli->query(
            "INSERT INTO pets (pets_name, species_id, breeds_id, pets_age, pets_gender, pets_neutered, pets_price, toys_id) VALUES ('$pets_name', '$species_id', '$breeds_id', '$pets_age', '$pets_gender', '$pets_neutered', '$pets_price', '$toys_id')"
         );
         $mysqli->close();
         return true;
      } else {
